...
class H5PFileStorage implements \H5PFileStorage
{
     ...
     */
    function __construct($path, FileManager $fileManager)
    {
        // Set H5P storage path
        $this->path = $path->getAbsoluteH5PPath();
        $this->alteditorpath =  null;
    ...
    public function cloneContentFile($file, $fromId, $toId)
    {
        ...
        $targetPath = '/content/' . $toId . '/' . $filedir . $filename;
        $this->fileManager->writeToStorage(file_get_contents($sourcepath), $targetPath);
    }
